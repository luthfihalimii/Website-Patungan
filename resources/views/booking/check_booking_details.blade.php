                            ...
                            <div class="flex items-center justify-between rounded-3xl border border-patungan-border p-6 gap-6">
                                <div class="flex items-center gap-4">
                                    <div class="flex w-[62px] h-[62px] shrink-0 rounded-xl overflow-hidden">
                                        <img src="{{ asset('assets/images/logos/netflix.png')}}" class="w-full h-full object-contain" alt="logo">
                                    </div>
                                    <div>
                            ...
                            <div class="flex flex-col gap-6">
                                    ...
                                    <div class="flex flex-col flex-1 rounded-3xl rounded-tl-[4px] p-6 gap-6 bg-patungan-bg-grey">
                                        <div class="message-text">
                                            <p class="font-semibold text-lg leading-8">
                                                Hooray, the group quantity has been fulfilled. Please log in to the account with the following information
                                            </p>
                                            <br>
                                            <p class="font-semibold text-lg leading-8">
                                                Netflix Email <br>
                                ...
                                <div class="message-card flex gap-4">
                                    ...
                                    <div class="flex flex-col flex-1 rounded-3xl rounded-tl-[4px] p-6 gap-6 bg-patungan-bg-grey">
                                        <div class="message-text">
                                            <p class="font-semibold text-lg leading-8">
                                                Pesanan Anda berhasil diverifikasi. Mohon menunggu hingga grup mencapai jumlah yang diperlukan sebelum kami mengirimkan akun yang Anda inginkan. Terima kasih atas kesabaran Anda! Jika ada kendala, kami akan segera menghubungi Anda.
                                            </p>
                                        </div>

                                        <span class="time font-bold leading-5 text-patungan-grey">Yesterday, 12:22 AM</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <p class="font-semibold text-lg leading-[22px] text-patungan-grey">Joined Sun,15 Sep 2024</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4">
                            <div class="w-16 h-16 flex shrink-0 rounded-full overflow-hidden">
    ...
    <main class="flex flex-col h-full items-center justify-center px-16 py-16">
        ...
        <div class="flex flex-col w-full max-w-[762px] mt-6 rounded-[32px] overflow-hidden">
            <div class="relative flex flex-col justify-center px-6 pt-8 pb-16 gap-1 -mb-8 text-center bg-[linear-gradient(113.19deg,#E25520_0%,#A83279_100.41%)]">
               <img src="{{ asset('assets/images/icons/messages-white..svg')}}" class="absolute w-full h-full object-cover object-top" alt="background">
                <p class="relative font-semibold text-xl leading-[25px] text-[#E2B9BB]">Your Booking Code:</p>
                <p class="relative font-bold text-[32px] leading-10 text-white">
