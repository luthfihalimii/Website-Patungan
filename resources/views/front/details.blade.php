...
<main class="flex flex-col w-full max-w-[1280px] mx-auto px-16 gap-9 mt-16">
    ...
    <div class="flex gap-9 mb-20">
                ...
                <div class="flex flex-col p-8 gap-6">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-6 flex shrink-0"
                                    alt="icon">
                                <p class="font-semibold text-lg leading-[22px] text-patungan-grey">{{ $kp->name }}</p>
                            </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div id="Price-Details"
            class="flex flex-col w-full h-fit rounded-[32px] p-8 gap-8 bg-white overflow-hidden">
            ...
            <div class="flex flex-col rounded-3xl border border-patungan-border p-6 gap-6">
                ...
                <div class="flex items-center justify-between">
                    <p class="font-semibold text-lg leading-[22px] text-patungan-grey">PPN {{ $tax_percent }}%</p>
                    <p class="font-bold text-xl leading-[25px]">{{ number_format($tax, 0, '.', ',' ) }}</p>
                </div>
                <hr class="border-patungan-border">
                <div class="flex items-center justify-between">
                    <p class="font-semibold text-lg leading-[22px] text-patungan-grey">Total Price</p>
                    <p class="font-bold text-xl leading-[25px text-patungan-red">Rp {{ number_format($total_price, 0, '.', ',' ) }}</p>
                </div>
            </div>
