    ...
    <nav class="relative w-full max-w-[1280px] mx-auto h-[140px]">
        <div class="fixed top-10 w-full max-w-[1280px] px-16 z-20">
            <div class="flex items-center w-full max-w-[1280px] h-[100px] mx-auto rounded-full p-5 pl-9 justify-between bg-white shadow-[0px_23px_35px_0px_#0C0F2405]">
                ...
                <a href="view-booking.html" class="flex items-center rounded-full border border-patungan-orange/10 bg-patungan-orange/10 h-[60px] px-9 gap-[6px]">
                    ...
                    <div class="flex flex-col p-6 gap-6">
                        ...
                        <div class="flex flex-col rounded-3xl border border-patungan-border p-4 gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('assets/images/icons/verify-green.svg') }}" class="w-[{{ number_format($itemNewProduct->price_per_person, 0, '.', ',' ) }}18px] flex shrink-0" alt="icon">
                                <p class="font-medium text-lg leading-[22px] text-patungan-grey">larang gausa tuku cok!</p>
                            </div>
                        </div>
